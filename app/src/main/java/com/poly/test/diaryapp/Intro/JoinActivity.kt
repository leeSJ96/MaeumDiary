...
import com.poly.test.diaryapp.models.AuthModel
import com.poly.test.diaryapp.utils.Constants.AuthOverLap
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        input_btn.setOnClickListener {
            ...
            when {
                ...
                name_input.length() > 13 -> {
                    Snackbar.make(join_layout, "닉네임은 12자 이하로 작성해주세요.", Snackbar.LENGTH_SHORT).show()
                }
